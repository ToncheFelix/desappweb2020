...
namespace DVDCollection.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public ActorsController(DVDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            //var actors = from c in _actors select c;
            var _actors = from s in _context.Actors select s;
            if (!string.IsNullOrEmpty(searchString)){
                _actors = _actors.Where(c=>c.ActorFullName.Contains(searchString));
            }

            return View(await _actors.ToListAsync());
        }
