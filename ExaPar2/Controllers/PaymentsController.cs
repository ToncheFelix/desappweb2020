...
namespace ReservacionesHotel.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        {
            var context = _context.Payments.Include(p => p.Booking).Include(p => p.Customer).Include(p => p.PaymentMethod);
        ...
        public async Task<IActionResult> Create([Bind("PaymentID,BookingID,CustomerID,PaymentMethodID,PaymentAmount,PaymentComments")] Payment payment)
        {
            ...
            ViewData["CustomerID"] = new SelectList(_context.Customers, "CustomerID", "CustomerAddressCountry", payment.CustomerID);
